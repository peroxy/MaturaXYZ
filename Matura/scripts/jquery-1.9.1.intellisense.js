...
intellisense.annotate(jQuery.fn, {
  ...
  'id': function() {
    /// <signature>
    ///   <summary>Selects a single element with the given ColumnId attribute.</summary>
    ///   <param name="ColumnId" type="String">An ID to search for, specified via the ColumnId attribute of an element.</param>
    /// </signature>
  },
  'image': function() {
